    ...
    <section className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-5 md:py-8 space-y-5">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          <div>
            ...
            <p className="text-sm md:text-base text-muted mt-2">
              รองรับการนำเข้าแบบ CSV และ JSON เพื่อสร้างกิจกรรมหลายรายการพร้อมกัน
            </p>
          </div>
      ...
      <div className="rounded-2xl bg-surface border border-border p-4 md:p-6 shadow-sm">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-2xl font-semibold text-foreground">ประวัติการนำเข้าของฉัน</h2>
        ...
        {isLoading ? (
          ...
          <div className="py-16 text-center text-muted text-sm">ยังไม่มีประวัติการนำเข้า</div>
        ) : (
          <>
